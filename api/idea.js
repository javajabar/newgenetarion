...
- без дорогих покупок;
- СТРОГОЕ ОГРАНИЧЕНИЕ: не повторяй идеи из списков "недавно были", "не понравились" и "исключить";
- если новая идея совпадает по смыслу, структуре или механике хотя бы частично — придумай другую;
- повторять или перефразировать идеи из этих списков запрещено;
  ...
  try {
    ...
    if (match) {
      try {
        ...
        console.error("[Nested JSON parse failed]", nestedError.message);
      }
    }
...
function fallbackIdea() {
  const ideas = [
    ...
    },
    {
      ...
      text: "Выбери один цвет и найди вокруг пять его неожиданных появлений. Последний объект должен быть самым странным, а итог можно сохранить как фото, список или мини-коллаж.",
      tags: ["наблюдение", "визуал", "город"],
    },
    {
      title: "Собери музей одного ящика",
      text: "Открой любой ящик и выбери семь предметов как экспонаты. Дай каждому название, год и короткую музейную подпись, будто это важная находка.",
      tags: ["творчество", "игра", "дом"],
    },
    {
      title: "Сними трейлер обычной вещи",
      text: "Выбери предмет рядом и сними 20 секунд так, будто это трейлер драматичного фильма. Нужны крупный план, загадочный поворот и финальный кадр.",
      tags: ["кино", "дом", "творчество"],
    },
    {
      title: "Запусти тихую лабораторию",
      text: "Проверь маленькую гипотезу: какой свет уютнее, какая чашка дольше держит тепло или какой порядок вещей быстрее. Запиши результат одной точной фразой.",
      tags: ["технологии", "дом", "эксперимент"],
    },
  ];
